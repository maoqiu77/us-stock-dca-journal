...
export const visionRowSchema = z.strictObject({ name: z.string().max(120).nullable(), code: z.string().max(32).nullable(), quantityText: z.string().max(40).nullable(), unitCostText: z.string().max(40).nullable(), costBasis: z.enum(['average_cost', 'breakeven', 'unknown']), currency: z.enum(['CNY', 'USD']).nullable(), accountLabel: z.string().max(80).nullable(), marketValueText: z.string().max(40).nullable().optional(), holdingPnlText: z.string().max(40).nullable().optional(), holdingReturnRateText: z.string().max(40).nullable().optional(), dailyChangeRateText: z.string().max(40).nullable().optional(), navText: z.string().max(40).nullable().optional(), navDateText: z.string().max(40).nullable().optional() });
