...
Page({
  ...
  onLoad(options = {}) {
    ...
    wx.setStorageSync('portfolio.wechat.navigation-intent.v1', { workspaceId: service.journal().read().instance_id, type: 'journal_date', date, expiresAt: Date.now() + 5 * 60 * 1000 });
