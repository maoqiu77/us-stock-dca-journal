...
Page({
  data: { error: '', id: '', conversation: null, messages: [], runs: [], question: '', previewData: null, label: '', cloud: false, busy: false, noteMessageId: '', noteDraft: '', focusMessage: '', turns: [], nextQuestions: [], title: '', inputFocus: false },
