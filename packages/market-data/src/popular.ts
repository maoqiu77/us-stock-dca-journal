...
const stocks = [
  ['NVDA', '英伟达'], ['AMD', '美国超微公司'], ['SPY', '标普500ETF'], ['AAPL', '苹果'], ['GOOG', '谷歌-C'], ['QQQ', '纳指100ETF'], ['QQQM', '纳斯达克100指数ETF-Invesco'], ['SMH', 'VanEck半导体ETF'],
...
const etfs = new Set([...arca, 'QQQ', 'QQQM', 'SMH', 'SOXX', 'TQQQ', 'SQQQ']);
